    ...
    <div className="notif-page">
      <header className="notif-header">
        ...
        <div className="notif-header-text">
          <h1>Notifikasyon</h1>
          {unreadCount > 0 && <span className="notif-count">{unreadCount} nouvo</span>}
        </div>
        {unreadCount > 0 && (
      ...
      {notifications.length === 0 ? (
        <div className="notif-empty">
          <div className="notif-empty-visual">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>
          </div>
